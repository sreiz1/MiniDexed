...
#else
	// up to 32 TGs available for all multicore systems, TGs will be divided equally
	static const unsigned MinToneGenerators = 1;
	static const unsigned AllToneGenerators = 32;
	static const unsigned DefToneGenerators = 12;
#endif
	
// Set maximum polyphony, limited more on RPI1. This can be changed via config settings
#if RASPPI == 1
